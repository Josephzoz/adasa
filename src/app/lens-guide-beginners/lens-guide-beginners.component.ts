...
@Component({
  selector: 'app-lens-guide-beginners',
  imports: [RouterLink,RouterLinkActive],
  templateUrl: './lens-guide-beginners.component.html',
  styleUrl: './lens-guide-beginners.component.css',
})
export class LensGuideBeginnersComponent {
    blogs: IPosts[] = [
      {
        id: 1,
