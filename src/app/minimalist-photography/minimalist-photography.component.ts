...
@Component({
  selector: 'app-minimalist-photography',
  imports: [RouterLink,RouterLinkActive],
  templateUrl: './minimalist-photography.component.html',
  styleUrl: './minimalist-photography.component.css',
})
export class MinimalistPhotographyComponent {
  blogs: IPosts[] = [
    {
      id: 1,
