...
@Component({
  selector: 'app-newborn-baby-photography',
  imports: [RouterLink,RouterLinkActive],
  templateUrl: './newborn-baby-photography.component.html',
  styleUrl: './newborn-baby-photography.component.css',
})
export class NewbornBabyPhotographyComponent {
    blogs: IPosts[] = [
      {
        id: 1,
