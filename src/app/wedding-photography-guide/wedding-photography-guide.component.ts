...
@Component({
  selector: 'app-wedding-photography-guide',
  imports: [RouterLink,RouterLinkActive],
  templateUrl: './wedding-photography-guide.component.html',
  styleUrl: './wedding-photography-guide.component.css',
})
export class WeddingPhotographyGuideComponent {
     blogs: IPosts[] = [
        {
          id: 1,
