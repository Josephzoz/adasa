...
@Component({
  selector: 'app-raw-vs-jpeg-explained',
  imports: [RouterLink,RouterLinkActive],
  templateUrl: './raw-vs-jpeg-explained.component.html',
  styleUrl: './raw-vs-jpeg-explained.component.css',
})
export class RawVsJpegExplainedComponent {
  blogs: IPosts[] = [
    {
      id: 1,
