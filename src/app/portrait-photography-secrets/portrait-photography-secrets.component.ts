...
@Component({
  selector: 'app-portrait-photography-secrets',
  imports: [RouterLink,RouterLinkActive],
  templateUrl: './portrait-photography-secrets.component.html',
  styleUrl: './portrait-photography-secrets.component.css',
})
export class PortraitPhotographySecretsComponent {
    blogs:IPosts[]=[
      {
        "id": 1,
