...
@Component({
  selector: 'app-travel-photography-tips',
  imports: [RouterLink,RouterLinkActive],
  templateUrl: './travel-photography-tips.component.html',
  styleUrl: './travel-photography-tips.component.css',
})
export class TravelPhotographyTipsComponent {
    blogs: IPosts[] = [
      {
        id: 1,
