...
@Component({
  selector: 'app-photo-editing-lightroom',
  imports: [RouterLink,RouterLinkActive],
  templateUrl: './photo-editing-lightroom.component.html',
  styleUrl: './photo-editing-lightroom.component.css',
})
export class PhotoEditingLightroomComponent {
      blogs: IPosts[] = [
        {
          id: 1,
