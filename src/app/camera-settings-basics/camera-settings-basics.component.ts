...
@Component({
  selector: 'app-camera-settings-basics',
  imports: [ RouterLink ,RouterLinkActive],
  templateUrl: './camera-settings-basics.component.html',
  styleUrl: './camera-settings-basics.component.css',
})
export class CameraSettingsBasicsComponent {
      blogs:IPosts[]=[
        {
          "id": 1,
