...
@Component({
  selector: 'app-night-photography-techniques',
  imports: [RouterLink,RouterLinkActive],
  templateUrl: './night-photography-techniques.component.html',
  styleUrl: './night-photography-techniques.component.css',
})
export class NightPhotographyTechniquesComponent {
            blogs:IPosts[]=[
              {
                "id": 1,
