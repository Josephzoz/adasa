...
@Component({
  selector: 'app-wildlife-photography-tips',
  imports: [RouterLink,RouterLinkActive],
  templateUrl: './wildlife-photography-tips.component.html',
  styleUrl: './wildlife-photography-tips.component.css',
})
export class WildlifePhotographyTipsComponent {
        blogs: IPosts[] = [
          {
            id: 1,
