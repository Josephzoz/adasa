...
@Component({
  selector: 'app-mobile-photography-tips',
  imports: [ RouterLink,RouterLinkActive],
  templateUrl: './mobile-photography-tips.component.html',
  styleUrl: './mobile-photography-tips.component.css',
})
export class MobilePhotographyTipsComponent {
        blogs:IPosts[]=[
          {
            "id": 1,
