...
@Component({
  selector: 'app-food-photography-basics',
  imports: [RouterLink,RouterLinkActive],
  templateUrl: './food-photography-basics.component.html',
  styleUrl: './food-photography-basics.component.css',
})
export class FoodPhotographyBasicsComponent {
   blogs: IPosts[] = [
        {
          id: 1,
