...
@Component({
  selector: 'app-drone-photography-basics',
  imports: [RouterLink,RouterLinkActive],
  templateUrl: './drone-photography-basics.component.html',
  styleUrl: './drone-photography-basics.component.css',
})
export class DronePhotographyBasicsComponent {
       blogs: IPosts[] = [
          {
            id: 1,
