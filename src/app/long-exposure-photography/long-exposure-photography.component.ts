...
@Component({
  selector: 'app-long-exposure-photography',
  imports: [ RouterLink,RouterLinkActive],
  templateUrl: './long-exposure-photography.component.html',
  styleUrl: './long-exposure-photography.component.css',
})
export class LongExposurePhotographyComponent {
              blogs:IPosts[]=[
                {
                  "id": 1,
