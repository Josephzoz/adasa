...
@Component({
  selector: 'app-product-photography-essentials',
  imports: [RouterLink,RouterLinkActive],
  templateUrl: './product-photography-essentials.component.html',
  styleUrl: './product-photography-essentials.component.css',
})
export class ProductPhotographyEssentialsComponent {
    blogs: IPosts[] = [
      {
        id: 1,
