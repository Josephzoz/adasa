...
@Component({
  selector: 'app-street-photography-guide',
  imports: [RouterLink,RouterLinkActive],
  templateUrl: './street-photography-guide.component.html',
  styleUrl: './street-photography-guide.component.css',
})
export class StreetPhotographyGuideComponent {
    blogs: IPosts[] = [
      {
        id: 1,
