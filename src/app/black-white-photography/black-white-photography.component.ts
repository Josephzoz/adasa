...
@Component({
  selector: 'app-black-white-photography',
  imports: [RouterLink,RouterLinkActive],
  templateUrl: './black-white-photography.component.html',
  styleUrl: './black-white-photography.component.css',
})
export class BlackWhitePhotographyComponent {
     blogs: IPosts[] = [
          {
            id: 1,
