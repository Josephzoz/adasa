...
@Component({
  selector: 'app-architecture-photography',
  imports: [RouterLink, RouterLinkActive],
  templateUrl: './architecture-photography.component.html',
  styleUrl: './architecture-photography.component.css',
})
export class ArchitecturePhotographyComponent {
  blogs: IPosts[] = [
    {
      id: 1,
