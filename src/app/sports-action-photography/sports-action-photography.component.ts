...
@Component({
  selector: 'app-sports-action-photography',
  imports: [RouterLink,RouterLinkActive],
  templateUrl: './sports-action-photography.component.html',
  styleUrl: './sports-action-photography.component.css',
})
export class SportsActionPhotographyComponent {
  blogs: IPosts[] = [
    {
      id: 1,
