...
@Component({
  selector: 'app-color-theory-photography',
  imports: [RouterLink,RouterLinkActive],
  templateUrl: './color-theory-photography.component.html',
  styleUrl: './color-theory-photography.component.css',
})
export class ColorTheoryPhotographyComponent {
      blogs: IPosts[] = [
        {
          id: 1,
