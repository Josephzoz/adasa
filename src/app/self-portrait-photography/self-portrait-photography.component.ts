...
@Component({
  selector: 'app-self-portrait-photography',
  imports: [RouterLink,RouterLinkActive],
  templateUrl: './self-portrait-photography.component.html',
  styleUrl: './self-portrait-photography.component.css',
})
export class SelfPortraitPhotographyComponent {
      blogs: IPosts[] = [
        {
          id: 1,
