...
@Component({
  selector: 'app-macro-photography-world',
  imports: [RouterLink,RouterLinkActive],
  templateUrl: './macro-photography-world.component.html',
  styleUrl: './macro-photography-world.component.css',
})
export class MacroPhotographyWorldComponent {
  blogs: IPosts[] = [
    {
      id: 1,
