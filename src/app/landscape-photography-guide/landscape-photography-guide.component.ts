...
@Component({
  selector: 'app-landscape-photography-guide',
  imports: [RouterLink,RouterLinkActive],
  templateUrl: './landscape-photography-guide.component.html',
  styleUrl: './landscape-photography-guide.component.css',
})
export class LandscapePhotographyGuideComponent {
    blogs:IPosts[]=[
      {
        "id": 1,
