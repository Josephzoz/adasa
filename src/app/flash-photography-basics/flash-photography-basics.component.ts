...
@Component({
  selector: 'app-flash-photography-basics',
  imports: [RouterLink, RouterLinkActive],
  templateUrl: './flash-photography-basics.component.html',
  styleUrl: './flash-photography-basics.component.css',
})
export class FlashPhotographyBasicsComponent {
  blogs: IPosts[] = [
    {
      id: 1,
