...
@Component({
  selector: 'app-photo-composition-rules',
  imports: [RouterLink,RouterLinkActive],
  templateUrl: './photo-composition-rules.component.html',
  styleUrl: './photo-composition-rules.component.css',
})
export class PhotoCompositionRulesComponent {
          blogs:IPosts[]=[
            {
              "id": 1,
